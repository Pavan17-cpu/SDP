...
flex: 0; /* Don't grow, maintain its own size */
        ...
        <form action="/admincateringSearch"  method="post" autocomplete="off">
...
<button type="submit" class="btn btn-dark" name="addcater" style="background-color: black; color: white;">Add cater</button>
...
<br />
        ...
        <div class="table-responsive">
                ...
                <tbody>
                	 <c:forEach var="allcater" items="${caterlist}" >
			           ...
			           <td ><img src="data:image/jpeg;base64,${allcater.cater_img}" class="rounded-circle" width="100" height="100"/></td>
                        ...
                        <td class="d-flex">
                            <a class="btn btn-dark edit" data-toggle="modal" name="edit_cater" data-target="#EditcaterModal" data-whatever="@mdo" style="background-color: black; color: white; margin-right: 10px;">EDIT</a>
                            <input type="hidden" value="${allcater.id}" id="edit_id">
                            <a href="/admindeletecater/${allcater.id}" class="btn btn-dark" onclick='return deleteCatering()' style="background-color: black; color: white;">DELETE</a>
            ...
            <div style="display: flex; justify-content: space-between;">
                ...
                <form >
                    <button type="button" class="btn btn-dark" name="add_cater" data-toggle="modal" data-target="#AddcaterModal" data-whatever="@mdo" style="background-color: black; color: white;">Add cater</button>
			 ...
			 <div class="modal fade" id="EditcaterModal" tabindex="-1" role="dialog" aria-labelledby="AdduserModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					...
					<form action="/EditcaterForm" modelAttribute="caterEditForm" method="POST" enctype= "multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-dark" data-dismiss="modal" style="background-color: black; color: white;">Close</button>
<button type="submit" class="btn btn-dark" name="Editcater" style="background-color: black; color: white;">Edit cater</button>
