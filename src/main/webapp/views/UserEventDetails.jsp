...
<div class="album py-5 bg-light">
  ...
  <div class="row mb-4">
    <div class="col-md-12">
      <div class="card">
        <img src="data:image/jpeg;base64,${allevent.event_img}" class="card-img-top" alt="Thumbnail" style="width: 100%; max-height: 400px;">
        <div class="card-body">
          <h5 class="card-title" style="font-weight: bold; color: black;">EventName: ${allevent.eventname}</h5>
          <p class="card-text" style="font-weight: bold; color: black;">EventDescription: ${allevent.event_desc}</p>
